...
namespace ShopOnline.Api.Migrations
{
    public partial class FixSeedData : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "CartItems",
                columns: new[] { "Id", "CartId", "ProductId", "Qty" },
                values: new object[,]
                {
                    { 1, 1, 1, 10 },
                    { 2, 2, 2, 20 },
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "ImageURL", "Name", "Price", "Qty" },
                values: new object[] { "Sweety watermelon", "", "Watermelon", 2m, 6 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "ImageURL", "Name", "Price", "Qty" },
                values: new object[] { "Yellow african bananas", "", "Banana", 5m, 16 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "ImageURL", "Name", "Price", "Qty" },
                values: new object[] { "Sweet and taste orange", "", "Orange", 4m, 10 });
        }
    }
}
